...
{
    /// <summary>
    /// Dynamic Directory Module Catalog
    /// </summary>
    public class DynamicDirectoryModuleCatalog : ModuleCatalog
    {
        ...
        private class InnerModuleInfoLoader : MarshalByRefObject
        {
            ...
            internal ModuleInfo[] GetModuleInfos(string path, bool isFile = false)
            {
                ...
                IEnumerable<ModuleInfo> modules = GetNotAlreadyLoadedModuleInfos(info, IModuleType);
                AppDomain.CurrentDomain.ReflectionOnlyAssemblyResolve -= resolveEventHandler;
            ...
            /// <summary>
            /// Get Not Already Loaded Module Infos
            /// </summary>
            /// <param name="info"></param>
            /// <param name="IModuleType"></param>
            /// <returns></returns>
            private static IEnumerable<ModuleInfo> GetNotAlreadyLoadedModuleInfos(FileSystemInfo info, Type IModuleType)
            {
